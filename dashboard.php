...
<?php include 'inc/templates/header.php'; ?>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Votes
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Companies
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- End of Main Content -->
            <!-- Page level plugins -->
		    <script src="/taswit/layout/vendor/chart.js/Chart.min.js"></script>
            <!-- Page level custom scripts -->
		    <script src="/taswit/layout/js/demo/chart-pie-demo.js"></script>
