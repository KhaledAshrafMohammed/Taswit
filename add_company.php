    ...
    <div id="content">
      ...
      <div class="card-fluid ">
        ...
        <div class="row justify-content-center">
          <!-- Add Company -->
          <div class="col-md-9">
            <div class="addcompany-form">
              <!-- form Add Company -->
              <form class="card mt-4 border p-5 bg-light shadow" action="" method="POST">
                <h3 class=" card-header-pills mb-4 text-gray-800"> Add Company</h3>
                ...
                <div class="form-group row">
                  <label for="email" class="col-sm-2 col-form-label col-form-label-lg">Description</label>
                  <div class="col-md-10 py-1">
                    <input type="text" class="form-control form-control-lg" id="email" name="description">
                  </div>
                </div>
      ...
      if (isset($_SESSION['Username'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          $protectdesc   = htmlspecialchars($desc, ENT_QUOTES, 'UTF-8');

          include 'inc/errors.php';
          // check if we didn't have errors
          if (empty($newitemErrors)) {
            // Insert into the DB this Info
            $stmt = $con->prepare("INSERT INTO companies(Name, Description, regDate) VALUES (?, ?, now())");
            $stmt->execute(array($protectname, $protectdesc));

            // echo success message
            echo '<div class="alert alert-success">Company Added Successfully</div>';
          }
        }
      }
      ?>
