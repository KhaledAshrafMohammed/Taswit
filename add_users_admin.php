      ...
      <div id="content">
            ...
            <div class="col-md-9">
              <div class="adduser-form">
                ...
                <form action="" class="card mt-3 border p-4 bg-light shadow" method="POST">
                  <h3 class=" card-header-pills mb-4 text-gray-800"> Add Admin</h3>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10 py-1">
                      <select name="role" class="browser-default custom-select custom-select-lg" size="1" aria-label="size 3 select example">
                        <option selected></option>
                        <option value="1">Application Administrator</option>
        ...
        if (isset($_SESSION['Username'])) {
          ...
          if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $role         = $_POST['role'];
            $protectRole   = htmlspecialchars($role, ENT_QUOTES, 'UTF-8');
            ...
            if (empty($newitemErrors)) {
              ...
              $stmt = $con->prepare("INSERT INTO admins(Name, Email, roleID, Date, companyID, Position, Phone) VALUES (?, ?, ?, now(), ?, ?, ?)");
              $stmt->execute(array($protectName, $protectEmail, $protectRole, $protectCompany, $protectPosition, $protectPhone));
